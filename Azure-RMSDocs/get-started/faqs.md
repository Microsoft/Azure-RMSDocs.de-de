...
Um Benutzer anzugeben, die nicht zu Ihrer Organisation gehören, verwenden Sie das [Windows PowerShell-Modul für Azure Rights Management](../deploy-use/install-powershell.md):
