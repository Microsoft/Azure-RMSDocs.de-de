...
# <a name="howto-work-with-encryption-settings"></a>Exemplarische Vorgehensweise: Arbeiten mit Verschlüsselungseinstellungen
...
## <a name="protect-files-with-aes128-cbc4k"></a>Schützen von Dateien mit AES-128 CBC4K 
...
## <a name="protect-files-with-aes128-ecb-deprecated-algorithms"></a>Schützen von Dateien mit AES-128 ECB (veraltete Algorithmen)
