...
-   [**Szenario**: Zugriff auf Informationen der Schutzrichtlinie einer geschützten Datei](#scenario__access_protection_policy_information_from_a___protected_file)
-   [**Szenario**: Erstellen einer neuen geschützten Datei mithilfe einer Vorlage](#scenario__create_a_new_protected_file_using_a_template)
-   [**Szenario**: Schützen einer Datei mit benutzerdefiniertem Schutz](#scenario__protect_a_file_using_custom_protection)
-   [WorkerThread – eine unterstützende Methode](#workerthread_-_a_supporting_method)
-   [**Szenario**: RMS-Authentifizierung](#scenario__rms_authentication)
