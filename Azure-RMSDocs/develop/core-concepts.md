...
- [Vorgehensweise: Verwenden integrierter Rechte:](built-in-rights-usage-restriction-reference.md) Erläuterungen zu den integrierten Rechten, die das RMS SDK 4.2 bereitstellt, und Nutzungseinschränkungen, die eine App im Rahmen dieser Einschränkungen erzwingen soll.
