...
description: Informieren Sie sich über RMS-Rechte, Nutzungseinschränkungen und allgemeine Erzwingungs Punkte. Erfahren Sie, wie Sie Ihren Code aktualisieren, um Zugriffs Überprüfungen durchzuführen und bestimmte Rechte zu erzwingen.
keywords: ''
author: msmbaldwin
ms.author: mbaldwin
manager: barbkess
...
Die Berechtigungen eines Benutzers für ein Dokument können mit der [IpcAccessCheck](/previous-versions/windows/desktop/msipc/ipcaccesscheck)-Funktion abgefragt werden.
...
-   Identifizieren von Erzwingungspunkten für die Nutzungseinschränkung
    ...
    In Ihrer Anwendung sind unter Umständen nicht alle Erzwingungspunkte erforderlich, die unter [Referenz für die Nutzungseinschränkung](#usage-restriction-reference) beschrieben sind. Wenn Ihre Anwendung z. b. nicht zulässt, dass Benutzerinhalte drucken, muss Sie nicht nach dem **\_ generischen IPC- \_ Druck** Recht suchen.
...
|Kein AD RMS-Recht <br><br> Keine Beschreibung <br><br> **Allgemeine Erzwingungspunkte**: ALT+DRUCK|Rufen Sie [IpcProtectWindow](/previous-versions/windows/desktop/msipc/ipcprotectwindow) für alle Fenster auf, die Dokumentinhalte rendern.|
...
|**IPC_GENERIC_COMMENT** <br><br> Einige Programme unterstützen die Möglichkeit, Kommentare und Anmerkungen dem Dokument hinzuzufügen, ohne Dokumentkerninhalte zu aktualisieren.<br><br>Dieses Recht erteilt den Benutzer Zugriff auf diese Funktion. <br><br> **Allgemeine** Erzwingungs Punkte: <br><br> Prüfung > Kommentar einfügen <br><br> Prüfung > Kommentar löschen | Alle Menüelemente deaktivieren, die zum Ändern von Dokumentkommentaren oder -anmerkungen verwendet werden können. **Überprüfen**  >  **Insert Comment** und **Review**  >  **Delete Comment** sind Beispiele. <br><br>Alle Tastenkombination deaktivieren, die Änderungen der Dokumentkommentare auslösen könnten.<br><br>**Hinweis**: Eine standardmäßige Implementierung setzt voraus, dass **IPC_GENERIC_COMMENT** und **IPC_GENERIC_WRITE** neue Kommentare in einer Datei beibehalten. Anwendungen können Unterstützung für den Fall hinzufügen, dass das **IPC_GENERIC_COMMENT**-Recht erteilt wird, das **IPC_GENERIC_WRITE**-Recht aber nicht. In diesem Fall ist es zulässig, das Speichern zu ermöglichen, sofern Dokumentänderungen nur auf Kommentare beschränkt sind.|
|**IPC_VIEW_RIGHTS** <br><br> Keine Beschreibung <br><br> **Allgemeine Erzwingungspunkte**: N/V|Durch das System erzwungen. Das System lässt es nicht zu, dass der Entwickler die [**Liste mit Benutzerrechten**](/previous-versions/windows/desktop/msipc/ipc-user-rights-list) aus einer Lizenz abfragt, sofern dieses Recht nicht erteilt wird.
