...
Ein cloudbasierter Schlüssel schützt die Dokumente und E-Mails Ihrer Organisation durch die Verwendung eines privaten Schlüssels für die Organisation, die von Microsoft (standardmäßig) oder von Ihnen (das „Bring Your Own Key“- bzw. BYOK-Szenario) verwaltet wird. Weitere Informationen zu Mandantenschlüsseloptionen finden Sie unter [Planen und Implementieren Ihres Azure Information Protection-Mandantenschlüssels](../plan-design/plan-implement-tenant-key.md).

Dokumente und E-Mails, die Sie schützen, können in der Cloud oder lokal gespeichert werden. Weitere Informationen über die Funktionsweise des Schutzvorgangs für diesen cloudbasierten Schlüssel finden Sie unter [Was ist Azure Rights Management?](../understand-explore/what-is-azure-rms.md )
...
- Anweisungen für die Migration aus AD RMS finden Sie unter [Migrieren von AD RMS zu Azure Information Protection](../plan-design/migrate-from-ad-rms-to-azure-rms.md).
...
Informationen zum Konfigurieren einer Bezeichnung für den HYOK-Schutz finden Sie unter [Konfigurieren einer Bezeichnung für den Rights Management-Schutz](../deploy-use/configure-policy-protection.md). 
