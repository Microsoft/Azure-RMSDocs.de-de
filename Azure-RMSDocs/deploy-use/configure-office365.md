...
4. Führen Sie den [Get-IRMConfiguration](https://technet.microsoft.com/library/dd776120(v=exchg.160\).aspx)-Befehl aus, um die Exchange Online-Konfiguration für Ihren Schutzdienst anzuzeigen:
    ...
    - Wenn AzureRMSLicensingEnabled auf **FALSE** festgelegt ist, führen Sie die unter [Set up new Office 365 Message Encryption capabilities built on top of Azure Information Protection (Einrichten neuer Office 365-Meldungsverschlüsselungsfunktionen mit Azure Information Protection)](https://support.office.com/article/7ff0c040-b25c-4378-9904-b1b50210d00e) erläuterten Befehle aus. 
...
Wenn Azure Rights Management für Exchange Online aktiviert ist, können Sie Features konfigurieren, die den Informationsschutz automatisch anwenden. Hierzu gehören z.B. [Transportregeln](https://technet.microsoft.com/library/dd302432.aspx), [DLP-Richtlinien (Data Loss Prevention)](https://technet.microsoft.com/library/jj150527%28v=exchg.150%29.aspx) und [geschützte Voicemail](https://technet.microsoft.com/library/dn198211%28v=exchg.150%29.aspx) (Unified Messaging).
...
2.  Bewegen Sie den Mauszeiger auf die Kachel **Dokumente**, klicken Sie auf die Auslassungspunkte (**...**), und klicken Sie dann auf **Einstellungen**.
