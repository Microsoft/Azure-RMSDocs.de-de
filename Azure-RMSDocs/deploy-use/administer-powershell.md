...
description: "Erfahren Sie, wie Sie das Windows PowerShell-Modul für Azure RMS (AADRM) verwenden können, um diesen Dienst für Ihre Organisation zu verwalten."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
