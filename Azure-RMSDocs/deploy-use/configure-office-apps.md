...
description: Ermitteln Sie anhand dieser Informationen, was zu tun ist, damit die von Ihren Endbenutzern verwendeten Office-Apps zusammen mit Azure Rights Management (Azure RMS) funktionieren.
author: cabailey
manager: mbaldwin
ms.date: 08/24/2016
ms.topic: article
