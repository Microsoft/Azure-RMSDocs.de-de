...
Verwenden Sie diese Anweisungen, wenn Sie den Azure Rights Management-Dienst (Azure RMS) über das Azure-Portal aktivieren möchten. Diese Aktivierungsmethode befindet sich derzeit in der Vorschauphase.
