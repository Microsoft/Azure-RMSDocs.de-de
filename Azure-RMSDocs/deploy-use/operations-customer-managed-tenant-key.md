...
description: "Informationen zu den Lebenszyklusvorgängen, die relevant sind, wenn Ihr Mandantenschlüssel für Azure RMS (Azure Rights Management) von Ihnen verwaltet wird (BYOK-Szenario, „Bring Your Own Key“)."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
