...
|Allgemeiner Name: **Anzeigen, Öffnen, Lesen** <br /><br />Richtliniencodierung: **VIEW**|Ermöglicht es dem Benutzer, das Dokument zu öffnen und den Inhalt zu sehen.<br /><br /> In Excel ist dieses Recht nicht ausreichend, um Daten zu sortieren oder zu filtern oder um Pivottabellen zu erstellen. Diese Aktionen erfordern eins der folgenden Rechte: **Inhalt bearbeiten, Bearbeiten**. [Weitere Informationen](https://cloudblogs.microsoft.com/enterprisemobility/2015/12/09/enabling-document-interaction-sort-filter-etc-while-disabling-saving-with-rms/)|Benutzerdefinierte Office-Rechte: als benutzerdefinierte Option **Lesen**, Option **Anzeigen**<br /><br />Name im klassischen Azure-Portal: **Anzeigen**<br /><br />Name im Azure-Portal: **Anzeigen, Öffnen, Lesen (VIEW)**<br /><br />Name in den AD RMS-Vorlagen: **Allen antworten** <br /><br />API-Konstante oder -Wert: `IPC_GENERIC_READ L"VIEW"`|
