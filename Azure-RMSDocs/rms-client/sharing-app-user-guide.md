...
Sie benötigen lediglich einen Computer, auf dem mindestens Windows 7 mit Service Pack 1 läuft. Anschließend können diese kostenlose Anwendung von Microsoft [herunterladen und installieren](https://go.microsoft.com/fwlink/?LinkId=303970) .
