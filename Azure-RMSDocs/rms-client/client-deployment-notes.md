...
1.  Öffnen Sie auf dem AD RMS-Server die Active Directory Management Services-Konsole:
    ...
    - Wählen Sie unter Windows Server 2008 R2 **Start** die Option  >  **Verwaltungs Tools**  >  **Active Directory Rights Management Services** starten aus.
