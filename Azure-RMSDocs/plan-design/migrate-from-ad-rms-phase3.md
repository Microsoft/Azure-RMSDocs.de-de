...
description: "Verwenden Sie die folgenden Informationen für Phase 3 der Migration von AD RMS zu Azure Rights Management (Azure RMS). Diese Verfahren beziehen sich auf die Schritte 6 bis 7 der Migration von AD RMS zu Azure Rights Management."
author: cabailey
manager: mbaldwin
ms.date: 08/17/2016
ms.topic: article
