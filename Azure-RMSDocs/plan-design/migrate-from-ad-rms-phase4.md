...
description: Phase 4 der Migration von AD RMS zu Azure Rights Management (Azure RMS). Deckt die Schritte 8 und 9 der Migration von AD RMS zu Azure Rights Management ab.
author: cabailey
manager: mbaldwin
ms.date: 08/17/2016
ms.topic: article
