...
description: Phase 1 der Migration von AD RMS zu Azure Rights Management (Azure RMS). Deckt die Schritte 1 und 4 der Migration von AD RMS zu Azure Rights Management ab.
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
