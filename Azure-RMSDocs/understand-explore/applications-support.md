...
description: "Erfahren Sie, wie die am häufigsten verwendeten Anwendungen Ihrer Endbenutzer (z.B. Office-Anwendungen, Word, Excel, PowerPoint und Outlook) und Dienste (z.B. Exchange und SharePoint) die Daten Ihrer Organisation mithilfe von Microsoft Azure Rights Management besser schützen können."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
