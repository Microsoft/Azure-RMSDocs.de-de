...
Führen Sie das Cmdlet [Get-aipservicesuperuser](/powershell/module/aipservice/get-aipservicesuperuser) und das Cmdlet [Get-aipservicerolebasedadministrator](/powershell/module/aipservice/get-aipservicerolebasedadministrator) aus, um anzuzeigen, welchen Benutzern die Rolle "Administrator" oder "globaler Administrator" für den Schutzdienst (Azure Rights Management) von Azure zugewiesen wurde. Information Protection. Die E-Mail-Adressen der Benutzer, denen eine dieser Rollen zugewiesen wurde, werden angezeigt.
...
Personenbezogene Daten, die Sie mit dem aipservice-Modul (oder dem älteren Modul, aadrm) anzeigen und angeben, können nur für Benutzer zugänglich gemacht werden, denen der **Azure Information Protection Administrator**, **Compliance-Administrator**, Konformität zugewiesen wurde.  **Daten Administrator**oder **globale Administrator** Rollen von Azure Active Directory oder die globale Administrator Rolle für den Schutzdienst.
