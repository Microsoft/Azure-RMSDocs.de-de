...
- [Voraussetzungen für den Azure Information Protection-Client für einheitliche Bezeichnungen](./rms-client/clientv2-admin-guide-install.md#additional-prerequisites-for-the-azure-information-protection-unified-labeling-client)

- [Voraussetzungen für den Azure Information Protection-Client](./rms-client/client-admin-guide-install.md#additional-prerequisites-for-the-azure-information-protection-client)
...
Stellen Sie sicher, dass Sie für die folgenden Diensttags den Zugriff auf alle Ports zulassen:

- **AzureInformationProtection**
- **AzureActiveDirectory**
- **AzureFrontDoor.Frontend**

Der Azure Information Protection-Dienst benötigt zwei bestimmte IP-Adressen:
 - **13.107.6.181** 
 - **13.107.9.181**
