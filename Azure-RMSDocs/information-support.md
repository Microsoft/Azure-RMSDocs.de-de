...
Weitere Informationen zu neuen Versionen und Vorschau Versionen finden Sie im [Azure Information Protection Unified Bezeichnung Client-Version Release History und Support Policy](rms-client/unifiedlabelingclient-version-release-history.md).
...
- [Aufgezeichnete Sitzungen von der Microsoft Ignite](what-is-information-protection.md#additional-resources)
...
- Wenn Sie eine Frage zu einer Support Anweisung für Azure Information Protection haben, finden Sie weitere Informationen unter [Anforderungs](requirements.md) Informationen.
...
- Informationen zum Azure Information Protection-Client finden Sie im Abschnitt [Installations Überprüfungen und Problem](./rms-client/clientv2-admin-guide.md#installation-checks-and-troubleshooting) Behandlung des Administrator Handbuchs dieses Clients, und vergewissern Sie sich, dass Sie eine [unterstützte Version](./rms-client/unifiedlabelingclient-version-release-history.md#servicing-information-and-timelines)verwenden. 

    Wenn eine Vorschauversion verfügbar ist, können Sie versuchen, zu sehen, ob das Problem behoben ist – nicht alle Korrekturen werden im Versionsverlauf aufgelistet.
