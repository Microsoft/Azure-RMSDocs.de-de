...
|Protokollierungsoption|Description|
|----------------|---------------|
...
|   Name des Felds   | W3C-Datentyp |                                                                                                                                                                          Description                                                                                                                                                                          |                                                            Beispielwert                                                            |
|----------------|---------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
...
|      Zeit      |     Zeit      |                                                                                                            Die UTC-Zeit im 24-Stunden-Format, zu der die Anforderung verarbeitet wurde.<br /><br />Die Quelle ist die lokale Uhr auf dem Server, von dem die Anforderung bearbeitet wurde.                                                                                                            |                                                              21:59:28                                                               |
...
|  admin-aktion  |     Bool      |                                                                                                                                    Gibt an, ob ein Administrator auf die Website zur Dokumentennachverfolgung im Administratormodus zugegriffen hat.                                                                                                                                    |                                                                Wahr                                                                 |
