...
- Informationen zum Installieren des Windows PowerShell-Moduls für Azure Rights Management, um die Migrations-URL festzulegen, finden Sie unter [Installieren des PowerShell-Moduls für AADRM](install-powershell.md).
